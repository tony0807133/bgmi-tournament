    ...
    <footer className="border-t border-white/[0.06] mt-16 py-10 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
          ...
          {/* Help */}
          <div>
            <p className="text-white font-bold text-xs uppercase tracking-wider mb-3">Help</p>
            <div className="space-y-2">
        ...
        <div className="border-t border-white/[0.06] pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-gray-700 text-xs">BGMI Arena is not affiliated with Krafton or BGMI.</p>
        </div>
      </div>
    </footer>
  );
