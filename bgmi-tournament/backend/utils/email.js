...
<style>
  ...
  .hdr h1{margin:0;font-size:26px;letter-spacing:2px}
  ...
  .card h2{margin:0 0 14px;color:#f97316;font-size:14px;text-transform:uppercase;letter-spacing:1px}
  ...
  .val{font-weight:bold;font-size:14px;color:#fff}
...
<div class="wrap">
  ...
  <div class="body">
    ...
    <div class="warn">⚠️ <strong>Important:</strong> Join the room 10 minutes before match time. Do not share these credentials.</div>
    <p style="color:#9ca3af;font-size:13px">Good luck, soldier! 🔥</p>
  </div>
  <div class="ftr">BGMI Arena &bull; Automated email, do not reply.</div>
</div>
</body></html>`
  });
};
...
<style>
  ...
  .cd{font-size:44px;font-weight:900;color:#22c55e}
