    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8 text-gray-400 text-sm leading-relaxed">
        <Section title="1. Acceptance of Terms">
          By accessing or using BGMI Arena, you agree to be bound by these Terms of Service. If you do not agree, please do not use the platform. We reserve the right to update these terms at any time.
        </Section>
        ...
        <Section title="3. Account Responsibility">
          You are responsible for maintaining the confidentiality of your account credentials. Any activity under your account is your responsibility. Report unauthorized access immediately. We reserve the right to suspend accounts that violate these terms.
        </Section>
        ...
        <Section title="4. Tournament Rules">
          <ul className="list-disc pl-5 space-y-1.5 mt-2">
            ...
            <li>Results are final once verified by admin. Disputes must be raised within 24 hours with screenshot evidence.</li>
        ...
        <Section title="6. Prize Distribution">
          Prizes are distributed to the team leader's wallet after admin verification of winning screenshots. BGMI Arena retains 20% of the total entry fee pool as a platform fee. Kill prizes are awarded only to top 3 ranked players.
        </Section>
        ...
        <Section title="7. Prohibited Conduct">
          <ul className="list-disc pl-5 space-y-1.5 mt-2">
            ...
            <li>Submitting fake, edited, or cropped screenshots</li>
        ...
        <Section title="10. Contact">
          For any questions regarding these terms, contact us at support@bgmiarena.com.
        </Section>
      </div>
    </div>
  );
